                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400">
                      {summary.source_info.word_count && (
                        <p><span className="font-medium">Word Count:</span> {summary.source_info.word_count}</p>
                      )}
                ...
                <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">
                    {quiz.source_info.word_count && (
                      <p><span className="font-medium">Word Count:</span> {quiz.source_info.word_count}</p>
                    )}
